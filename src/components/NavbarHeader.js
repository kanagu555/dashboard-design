...
const NavbarHeader = () => {
  return (
    <Navbar collapseOnSelect expand="lg" bg="light">
      <Container>
        <Navbar.Brand href="#home"><img src={logo} className="logo"/> DIGITAL EAST <span className="company-name">DESSY</span></Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          ...
          <Nav>
            ...
            <Nav.Link href="#memes" className="nav-link"><PersonFill className="nav-icon-person"/><br/>USER</Nav.Link>
          </Nav>
        </Navbar.Collapse>
      </Container>
    </Navbar>
